  ...
  return (
    <Layout>
      <div className="max-w-3xl mx-auto pt-8">
        ...
        <p className="text-black/60 mb-10">Choose what you'd like to do today.</p>
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          ...
          >
            ...
            <p className="text-sm text-black/60">Create or edit client product requirements.</p>
          </button>
          ...
          >
            ...
            <p className="text-sm text-black/60">Project tracking — coming soon.</p>
          </button>
        </div>
      </div>
      ...
      {showSoon && (
        ...
        >
          <div className="card max-w-sm w-full" onClick={(e) => e.stopPropagation()}>
            <h3 id="soon-title" className="text-lg font-semibold mb-2">Coming Soon</h3>
            <p className="text-sm text-black/70 mb-4">
              Project tracking is part of the Sales CRM module and will be available in a later release.
            </p>
            <button onClick={() => setShowSoon(false)} className="btn-primary w-full">OK</button>
          </div>
        </div>
      )}
    </Layout>
