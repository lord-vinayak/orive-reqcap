...
RESAMPLE_LOOP_BASE = [
    ...
    {'key': 'pickup_pending',           'display': 'Pickup Pending'},
...
ORDER_PHASE_SECTIONS = [
    {
        ...
        'display': 'Packaging',
        'stages': [
            {'key': 'pkg_pending',             'display': 'Packaging Pending'},
            ...
            {'key': 'pkg_order_pending',       'display': 'Packaging Order Pending'},
    ...
    },
    {
        ...
        'stages': [
            ...
            {'key': 'production_pending',            'display': 'Production Pending'},
