...
class BillingInfo(models.Model):
    ...
    # [{proposal_item_id, item_name, per_unit_cost, body_part, category, moq, size_ml}] — body_part/category
    # come from the Client Costing item's catalog data and drive invoice HSN classification;
    # moq seeds the invoice line item's Qty, size_ml seeds its Size (ml).
