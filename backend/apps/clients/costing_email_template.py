...
SUBJECT = "Product Costing for {brand_name} – Ready for Your Review"
...
<body style="font-family: Arial, sans-serif; font-size: 14px; color: #333333; line-height: 1.7; max-width: 680px; margin: 0 auto; padding: 24px;">
  ...
  <p>Please find attached the product costing for {brand_name} for your review.</p>

  <p>
    We've detailed everything you need to evaluate the numbers. Do go through it carefully, and if you have any questions or would like to discuss any line item, we're just an email away.
  </p>
...
Please find attached the product costing for {brand_name} for your review.
