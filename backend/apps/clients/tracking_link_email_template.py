...
# Template-specific tokens: {shipped_item}, {tracking_details}
# ============================================================

SUBJECT = "Your Package is Shipped"
...
<body style="font-family: Arial, sans-serif; font-size: 14px; color: #333333; line-height: 1.7; max-width: 680px; margin: 0 auto; padding: 24px;">
  ...
  <p>We have shipped your {shipped_item}.</p>

  <p>Sharing the tracking details for your reference: {tracking_details}</p>
...
We have shipped your {shipped_item}.

Sharing the tracking details for your reference: {tracking_details}
