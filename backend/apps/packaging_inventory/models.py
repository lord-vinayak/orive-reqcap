...
class PackagingRecord(models.Model):
    ...
    no_of_ordered_by_client = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True, verbose_name='No. Of Ordered by Client')
    quantity_sent = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
    used_in_batch = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
    price_per_unit = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True)
    damaged_missing = models.DecimalField(max_digits=10, decimal_places=2, null=True, blank=True, verbose_name='Damaged / Missing')
